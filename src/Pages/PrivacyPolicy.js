...
const PrivacyPolicy
 = () => {
  ...
  <Helmet>
  <title>Privacy Policy | Digital Partner</title>
  <meta
    name="description"
    content="Read Digital Partner’s Privacy Policy to understand how we collect, use, protect, and handle your personal information when you visit and use our website and services."
  />
</Helmet>
     ...
     <div style={{ width: "1200px", margin: "0 auto", padding: "20px"}}>
      <h2>Who we are</h2>
      <p>Our website address is: <a href="https://digitalpartner.ca">https://digitalpartner.ca</a>.</p>
      ...
      <p>
        ...
        <a href="https://automattic.com/privacy/"> here</a>. After approval of your comment, your profile
      ...
      <p>
        ...
        can recognise and approve any follow-up comments automatically instead of holding them in
        a moderation queue.
      </p>
      <p>
