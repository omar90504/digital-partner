    ...
    <section className="partner-section">
      <div className="partner-wrap animate__animated animate__fadeInRight">
        <div className="partner-header">
          <h3 className="partner-title">Powering Growth for Leading Brands</h3>
          <p className="partner-description">
            We help businesses strengthen their online presence with proven digital marketing strategies designed for real performance and long-term success.
          </p>
        </div>
