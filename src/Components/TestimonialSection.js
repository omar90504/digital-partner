        ...
        <div className="testimonial-top">
          ...
          <div className="testimonial-title">
            <div className="card-title">
              ...
              <p>
                Discover how businesses like yours achieved remarkable growth with Digital Partner’s expert marketing solutions.
              </p>
            </div>
          </div>
        </div>
...
<div class="elfsight-app-fd1719c1-e13f-4a5f-b816-f32c4b2a79b5" data-elfsight-app-lazy></div>
        </div>
      </div>
    </section>
  );
