    ...
    <BackgroundVideo src={Bannervideo}>
      ...
      <section className="hero-container position-relative">
        <div className="banner-content-wrapper">
          ...
          >
            Amplify Your Brand with High-Performance Digital Marketing
          </h1>
          ...
          <div className="banner-heading">
            ...
            >
              <div className="video-flex-box">
                ...
                <p>
                  Grow your business with data-driven digital marketing, creative branding, and strategies built to deliver real results.
                </p>
              </div>
            </div>
            ...
            >
              <p>
                We help businesses increase visibility, build trust, and attract the right customers — at the right time.
              </p>
