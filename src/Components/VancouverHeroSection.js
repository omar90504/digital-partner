...
import hero from "../Assets/images/vancouver.webp"; // Vancouver-specific image ho to replace karo

const VancouverHeroSection = () => {
  return (
    <header className="seo-header">
      <section className="seo-hero">
        ...
        <div className="seo-left">
          <h1>
            Digital Marketing<br /> Services in<br /> Vancouver <br />
          ...
          <p>
            ...
            companies across Vancouver to deliver measurable marketing results.
          </p>
        ...
        <div className="seo-right">
          <img src={hero} alt="Digital Marketing Services in Vancouver" />
        </div>
...
export default VancouverHeroSection;
