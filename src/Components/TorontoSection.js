import about from '../Assets/images/toronto10.webp'; 
...
const marketingPoints = [
  {
    ...
    description:
      "Our digital marketing strategies are designed to attract the right audience, increase website traffic, and convert visitors into real leads and paying customers in Toronto.",
    icon: faChartLine,
  },
  {
    title: "Multi-Channel Digital Growth",
    description:
      "We help your business grow across SEO, Google Ads, social media, and content marketing to maximize visibility and results across Toronto.",
    icon: faBullhorn,
  },
  {
    title: "Transparent Reporting & ROI Tracking",
    description:
      "Get clear monthly reports showing traffic growth, lead generation, conversions, and campaign performance for your Toronto campaigns so you always know your ROI.",
    icon: faUsers,
  }
];

const TorontoSection = () => {
  return (
    <section className="custom-seo-section">
      <div className="custom-seo-container">
        ...
        <div className="custom-seo-left">
          <img src={about} alt="Digital Marketing Services in Toronto" />
        </div>

        {/* Right Content */}
        <div className="custom-seo-right">
          <p className="custom-seo-subtitle">Digital Marketing Services in Toronto</p>
